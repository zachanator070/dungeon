...
room2.inventory = [
    {
        name: 'book',
        mobile: true,
        description: "An old book lies propped up against the wall. It's pages look filled with " +
    ...
    },
    {
        ...
        use: function (target) {
            if (target === null) {
                return "You sit down on the chair and start to template on life. You " +
                ...
                if (target.hasOwnProperty('name')) {
                    ...
                    return 'A sword is very useful, but not that useful.';
                }
            }
        }
    },
        ...
        use: function (target) {
            if (target === null) {
                ...
                return `You place the ${target.name} up against the glass so that the ${target.name}` +
                    " can take a look too. You feel proud to help out an inanimate object.";
            }
        }
    }
];
...
room3.inventory = [
    {
        name: 'sword',
        mobile: true,
        description: "The room is lit up with a spectacular light radiating from a glorious " +
        ...
        use: function (target) {
            if (target === null) {
                ...
                if (target.hasOwnProperty('name')) {
                    ...
                    return `The ${target.name} is threatened by your sword. Although it is inanimate,` +
...
room4.inventory = [
    {
        ...
        use: function () {
            room4.description = "Upon entering the room, you hear a loud \'BANG\' as steel bars fall" +
                " covering the doorway you just came through. You see no other exit from the room." +
                " The table has the remnants of a cake on it, left over from your party for one." +
